// Shared Tailwind class strings for the handful of UI primitives reused
// across components — kept in one place so the same look doesn't drift out
// of sync between copies.
